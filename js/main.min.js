...
(function() {
	...
	if(footerItem.classList.contains('dark-footer')){
		coociesColor = "dark"
	...
	if (!localStorage.getItem('cookieconsent')) {
		...
		\
	  <div class="cookieconsent ' + coociesColor  +'  " style="">\
	   <div class="container-cookies"> <p> We use cookies and other data as specified in <a class="accent-link" href="./private-policy"> Private Policy  </a>  to enhance site navigaion and improve our services. </p>  \
